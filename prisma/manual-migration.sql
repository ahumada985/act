...
-- Tabla de Consolidados Semanales
...
-- Tabla de relación Reporte-ConsolidadoSemanal (many-to-many)
...
-- Insertar plantillas de formularios por defecto
...
-- Comentario final
COMMENT ON TABLE "User" IS 'Tabla de usuarios del sistema (supervisores, admins, gerentes)';
COMMENT ON TABLE "Reporte" IS 'Tabla principal de reportes diarios de terreno';
COMMENT ON TABLE "Foto" IS 'Fotos asociadas a reportes';
COMMENT ON TABLE "Audio" IS 'Audios de voz asociados a reportes';
COMMENT ON TABLE "ConsolidadoSemanal" IS 'Consolidados semanales generados automáticamente';
COMMENT ON TABLE "PlantillaFormulario" IS 'Plantillas configurables de formularios por tipo de trabajo';
